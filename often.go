...
func (self *Often_t[Key_t, Mapped_t]) Create(key Key_t, value_init func(*Mapped_t), value_update func(*Mapped_t)) (res Mapped_t, ok bool) {
...
func (self *Often_t[Key_t, Mapped_t]) Remove(key Key_t) (ok bool) {
